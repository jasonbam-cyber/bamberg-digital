...
const PRODUCTS = [
  ...
  },
  {
    ...
    colors: ["Oat", "Slate", "Sage", "Midnight"],
    tag: "",
    rating: 4.7,
    reviews: 856,
  },
  ...
  {
    id: 6,
    name: "Mineralized Silk\u2122 Pillowcase",
    price: 102,
...
const BUNDLES = [
  {
    ...
    discount: 15,
    save: 21,
    desc: "Sleep Mask + Silk Pillowcase",
  },
  {
    name: "Ultimate Rest Bundle",
    items: [1, 3],
    discount: 12,
    save: 16,
    desc: "Sleep Mask + BODY Weighted Pod",
  },
  {
    name: "Silk Luxury Bundle",
    items: [2, 6, 7],
    discount: 10,
    save: 20,
    desc: "Silk Mask + Pillowcase + Scrunchies",
  },
];
      ...
      <div style={{ display: "flex", gap: 1 }}>
        {[1, 2, 3, 4, 5].map((i) => (
          <svg
            ...
            height="13"
            viewBox="0 0 24 24"
            fill={i <= Math.round(rating) ? TEXT_PRIMARY : "none"}
            stroke={TEXT_PRIMARY}
            strokeWidth="1.5"
          >
      ...
      >
        {remaining > 0 ? (
          <span style={{ color: TEXT_PRIMARY }}>
            <strong>${remaining.toFixed(0)}</strong> away from{" "}
            <strong>free shipping</strong>
          </span>
        ) : (
          <span style={{ color: ACCENT_GREEN, fontWeight: 500 }}>
      ...
      >
            ...
            cart.map((item) => (
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  {item.color && (
                    <div
                      style={{ fontSize: 11, color: TEXT_LIGHT, marginTop: 2 }}
                    >
                      {item.color}
                    </div>
                  )}
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ fontSize: 10, color: TEXT_LIGHT }}>
                        {u.reason}
                      </div>
                    </div>
                    <button
                      onClick={() => onAddUpsell(u.id)}
                      style={{
        ...
        {cart.length > 0 && (
          ...
          >
            ...
            >
              <span
                style={{ fontSize: 13, color: TEXT_SECONDARY, fontWeight: 300 }}
              >
                Subtotal
              </span>
              <span
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Add the{" "}
          <strong style={{ color: TEXT_PRIMARY, fontWeight: 500 }}>
            Silk Laundry Wash
          </strong>{" "}
          to protect your investment. This offer is only available right now.
        </p>
        <div
          style={{
            background: OFF_WHITE,
        ...
        >
          ...
          <div style={{ textAlign: "left" }}>
            <div style={{ fontWeight: 400, color: TEXT_PRIMARY, fontSize: 14 }}>
              Silk Laundry Wash
            </div>
            <div style={{ color: TEXT_LIGHT, fontSize: 12, marginTop: 2 }}>
              Gentle formula for silk & delicates
            </div>
            <div
              style={{
                display: "flex",
            ...
            >
              <span
                style={{ fontWeight: 500, color: ACCENT_GREEN, fontSize: 18 }}
              >
                $19
              </span>
              <span
      ...
      >
        {logos.map((src, i) => (
          <img
            ...
            src={src}
            alt="press"
            style={{ height: 24, opacity: 0.6, objectFit: "contain" }}
          />
        ))}
      </div>
    </div>
  ...
  return (
    ...
    >
      ...
      >
        {/* Left nav */}
        <nav
          className="nodpod-desktop-nav"
          style={{ display: "flex", gap: 28, alignItems: "center" }}
        >
          {["Shop", "Sleep Masks", "About"].map((lnk) => (
            <span
              key={lnk}
              className="nodpod-nav-link"
              style={{
                fontSize: 13,
                color: TEXT_SECONDARY,
                cursor: "pointer",
      ...
      >
        ...
        >
          <h1
            className="nodpod-hero-headline"
            style={{
              fontSize: 52,
              fontWeight: 400,
              color: WHITE,
                        ...
                        product.tag === "Best Seller"
                          ...
                          : product.tag === "Premium"
                            ...
                            : product.tag === "Cozy"
                              ...
                              : BEIGE,
                      color:
                        product.tag === "Best Seller" ? WHITE : TEXT_PRIMARY,
                      fontSize: 10,
                      padding: "4px 12px",
                      borderRadius: 2,
                      fontWeight: 500,
              ...
              <div style={{ padding: "16px 16px 20px" }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    padding: "10px 0",
                    background:
                      addedFlash === product.id ? ACCENT_GREEN : "transparent",
                    color: addedFlash === product.id ? WHITE : TEXT_PRIMARY,
                    border:
                      addedFlash === product.id
                        ? "none"
                        : `1px solid ${TEXT_PRIMARY}`,
                    borderRadius: 2,
                    fontSize: 12,
                    fontWeight: 400,
                    cursor: "pointer",
        ...
        >
          {BUNDLES.map((bundle) => {
            ...
            const saleTotal = Math.round(
              origTotal * (1 - bundle.discount / 100),
            );
            return (
              <div
                key={bundle.name}
                className="nodpod-bundle-card"
                style={{
                  borderRadius: 8,
                  overflow: "hidden",
                  background: WHITE,
      ...
      >
        ...
        >
          <div>
            ...
            >
              In 2009, Melissa began sewing the first nodpod prototype in her
              kitchen. Inspired by the calming science of Deep Touch Pressure,
              she set out to create the perfect sleep companion -- one that
              would feel like a gentle, reassuring weight across your eyes.
            </p>
            <p
              style={{
                fontSize: 14,
            ...
            >
              Today, nodpod is trusted by over 100,000 sleepers. Every mask is
              thoughtfully designed with premium materials and our patented
              4-pod system to deliver the deep rest you deserve.
            </p>
          </div>
          <div
            style={{
      ...
      <section
        className="nodpod-section"
        style={{ padding: "72px 40px", maxWidth: 1000, margin: "0 auto" }}
      >
        <div
          className="nodpod-features-grid"
          style={{
            display: "grid",
            gridTemplateColumns: "repeat(4, 1fr)",
            gap: 32,
          ...
          {[
            {
              ...
              icon: "\u{1F9E0}",
              desc: "Deep Touch Pressure calms the nervous system for deeper rest",
            },
            {
              title: "Premium Materials",
              icon: "\u2728",
              desc: "Mineralized silk and weighted microbeads for ultimate comfort",
            },
            {
              title: "30-Night Trial",
              icon: "\u{1F504}",
              desc: "Love it or return it, no questions asked",
            },
            {
              title: "Ships in 24 Hours",
              icon: "\u{1F4E6}",
              desc: "Complimentary shipping on all orders over $50",
            },
          ].map((f) => (
      ...
      >
        <div style={{ maxWidth: 640, margin: "0 auto" }}>
          ...
          >
            All nodpod products are OEKO-TEX certified, ensuring they are free
            from harmful substances. We use recyclable packaging and are
            committed to reducing our environmental footprint with every product
            we make.
          </p>
          <div
            style={{
        ...
        >
          ...
          <div>
            <img
              src={IMGS.logo}
              alt="nodpod"
              style={{ height: 24, marginBottom: 14, display: "block" }}
            />
            <p
              style={{
                fontSize: 13,
            ...
            >
              The original weighted sleep mask, designed to help you chill more,
          ...
          <div>
            ...
            {["FAQ", "Shipping & Returns", "Contact Us", "Privacy Policy"].map(
              (lnk) => (
                <a
                  key={lnk}
                  href="#"
